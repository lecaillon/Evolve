...
Over all Evolve embraces simplicity. Every time you build your project, Evolve will automatically ensure that your database is up-to-date, without having to do anything other than build.
